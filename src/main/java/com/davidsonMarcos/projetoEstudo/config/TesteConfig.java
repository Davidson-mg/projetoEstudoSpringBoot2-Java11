...
public class TesteConfig implements CommandLineRunner { 
	...
	É um metodo da interface CommandLineRunner. Instanciamos e salvamos no BD nossos objetos dentro deste metodo.*/
		...
		Ordem o1 = new Ordem(null, Instant.parse("2019-06-20T19:53:07Z"), u1); /*Esse formato de data e hora tá no padrão iso 8601. A letra "Z" no final indica que é UTC*/ 
		Ordem o2 = new Ordem(null, Instant.parse("2019-07-21T03:42:10Z"), u2); /*Repare que estamos usando a variavel u2 que é um obj usuario. Estamos instanciando o pedido (Ordem) passando o usuario associado a ele*/
		Ordem o3 = new Ordem(null, Instant.parse("2019-07-22T15:21:22Z"), u1); /*Lembrando que o horario do Brasil é 3h atrasado em relação ao UTC. Por isso vai retornar com 3 horas a mais do que o obj*/
