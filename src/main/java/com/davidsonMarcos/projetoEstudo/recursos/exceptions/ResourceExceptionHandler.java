...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler (ResourceNotFoundException.class) /*Serve para dizer que esse metodo vai interceptar qualquer exceção do tipo ResourceNotFoundException e tratar se possivel*/
